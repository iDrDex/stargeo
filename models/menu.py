...
response.menu = [
    ...
    (SPAN(T('Disease Tree'), _class="highlighted" if request.controller == 'tree' else ""),
     request.controller == 'tree',
     URL('tree', 'index', vars=request.vars.keywords and dict(keywords=request.vars.keywords))),
    (SPAN(T('Media'), _class="highlighted" if request.controller.startswith('media') else ""),
     request.controller.startswith('manage'),
     URL('media', 'index', vars=request.vars.keywords and dict(keywords=request.vars.keywords))),
